...
main_folder = BASE_PATH + "/aquapointer/data"
...
main_output_folder = BASE_PATH + "/aquapointer/aquapointer/analog/example_output"
...
locations = rism_to_locations(
    rism_file(sim_folder), BASE_PATH + "/aquapointer/aquapointer/analog/analog_settings_example1"
)
